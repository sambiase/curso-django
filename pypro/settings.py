...
# USING Python Decouple with dj-database-url
DATABASES = {
...
COLLECTFAST_ENABLED = False  # ambiente de Dev local
...
if AWS_ACCESS_KEY_ID:
    ...
    # AWS_AUTO_CREATE_BUCKET = False # nao iremos criar buckets automaticamente
    # AWS_QUERYSTRING_AUTH = True #gera urls assinadas
    # AWS_S3_CUSTOM_DOMAIN = True
    # AWS_DEFAULT_ACL = 'private'

    COLLECTFAST_ENABLED = True  # ambiente remoto de Des
    # Static Assets
    # -------------------------------------------------------
...
# using Python Decouple. SENTRY_DSN configured within .env
